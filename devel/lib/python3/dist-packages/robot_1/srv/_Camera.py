...
"""autogenerated by genpy from robot_1/CameraRequest.msg. Do not edit."""
import codecs
import sys
...
class CameraRequest(genpy.Message):
  _md5sum = "47d0f04bda78eec1a5109b1334da1dfd"
  _type = "robot_1/CameraRequest"
...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.angles,) = _get_struct_f().unpack(str[start:end])
      return self
...
def _get_struct_f():
    ...
    return _struct_f
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from robot_1/CameraResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
def _get_struct_BI():
    ...
    return _struct_BI
class Camera(object):
  _type          = 'robot_1/Camera'
  _md5sum = '0180f7bb4f5a39bc4ca26899b8eb533c'
