...
class CameraRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.float32(obj.angles, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.angles = _deserializer.float32(buffer, bufferOffset);
    return data;
  }
...
module.exports = {
  ...
  md5sum() { return '0180f7bb4f5a39bc4ca26899b8eb533c'; },
  datatype() { return 'robot_1/Camera'; }
};
